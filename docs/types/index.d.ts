...
*/
declare function typedarray( dtype?: DType ): TypedArray;
...
*/
declare function typedarray( length: number, dtype?: DType ): TypedArray;
...
*/
declare function typedarray( typedarray: TypedArray, dtype?: DType ): TypedArray; // tslint:disable-line:max-line-length
...
*/
declare function typedarray( obj: ArrayLike<number> | Iterable<any>, dtype?: DType ): TypedArray; // tslint:disable-line:max-line-length
...
*/
declare function typedarray( buffer: ArrayBuffer, dtype?: DType ): TypedArray;
...
* // returns <Float32Array>[ 0.0, 0.0 ]
*/
declare function typedarray( buffer: ArrayBuffer, byteOffset?: number, dtype?: DType ): TypedArray; // tslint:disable-line:max-line-length
...
*/
declare function typedarray( buffer: ArrayBuffer, byteOffset?: number, length?: number, dtype?: DType ): TypedArray; // tslint:disable-line:max-line-length
